...
$ python -m models.tsroie.infer_sroie --input images_folder/ --output output_folder/ --weight path_of_the_weights

Command for evaluation
$ python -m models.eval_dtd --data_root ./  --lmdb_name DocTamperV1-FCD --pth dtd_doctamper.pth --minq 75