...
dataset_paths = {
    ...
    'IMAGE_FOLDER': Path('input'),           # dossier contenant les images RGB
    'GT_FOLDER': Path('gt'),                 # dossier des masques binaires ground truth
    'SAVE_PRED': Path('output/predictions'), # dossier de sortie pour les prédictions
    'SAVE_VIS': Path('output/vis_catnet')    # dossier pour les visualisations combinées
